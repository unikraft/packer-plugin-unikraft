...
They are situated in a build directory which is created by Unikraft build system.
...
- `architecture` (string) - The architecture to build the image for. Examples: `x86_64`, `arm64`, `arm`.
- `platform` (string) - The platform to build the image for. Examples: `kvm`, `xen`, `linuxu`.
...
- `sources_no_default` (boolean) - Do not pull the default sources.
